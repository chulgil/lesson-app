...
| Repository (Mock/Remote) | 완료 (2026-05-31) | `data/repositories/mock_schedule_confirmation_card_repository.dart`, `data/repositories/remote_schedule_confirmation_card_repository.dart` — provider Remote 전환 완료 |
