...
| 항목 | 설명 |
|------|------|
| 시간 간격 | **30분 단위** (정시와 30분: 09:00, 09:30, 10:00...) |
| 레이아웃 | **4열 그리드** |
...
┌─────────────────────────────────────────┐
│  ┌─────┐ ┌─────┐ ┌─────┐ ┌─────┐      │
│  │09:00│ │09:30│ │10:00│ │10:30│       │  ← 회색: 가용시간 전
│  └─────┘ └─────┘ └─────┘ └─────┘      │
│  ┌─────┐ ┌─────┐ ┌─────┐ ┌─────┐      │
│  │11:00│ │11:30│ │12:00│ │12:30│       │
│  └─────┘ └─────┘ └─────┘ └─────┘      │
│  ┌─────┐ ┌─────┐ ┌─────┐ ┌─────┐      │
│  │13:00│●│13:30│ │14:00│ │14:30│       │  ← 13:00 선택됨 (Primary)
│  └─────┘ └─────┘ └─────┘ └─────┘      │
│  ┌─────┐ ┌─────┐ ┌─────┐ ┌─────┐      │
│  │15:00│ │15:30│ │16:00│ │16:30│       │
│  └─────┘ └─────┘ └─────┘ └─────┘      │
│  ┌─────┐ ┌─────┐                       │
│  │17:00│ │17:30│                        │  ← 회색: 레슨시간 초과
│  └─────┘ └─────┘                       │
└─────────────────────────────────────────┘
```
...
5주차가 있는 달에 1주차 시작인 경우만:
```
│  첫 달 수강료              150,000원    │
│                    (3주분, 5주차 휴강)   │
```

> **참고**: 2주차 이상부터 시작하는 경우 "5주차 휴강" 메시지는 표시하지 않음
