...
>
> **👉 연결 플로우 상세**:
> - [앱 사용 플로우](../../_archive/old/flow_with_app.md) - 신규/재등록/앱 전환 전체 플로우 (아카이브됨)
> - [기존 정기레슨 → 앱 전환](../../_archive/old/flow_with_app.md#25-기존-정기레슨--앱-전환-플로우) - 오프라인 학생 앱 전환 (아카이브됨)
>
> 본 문서에서 유효한 부분:
> - ✅ 학부모 연결 시스템
> - ✅ 학원-선생님 소속 시스템
...
| **레슨 노트** | ❌ | ✅ 선생님 레슨 노트 확인 |
| **결제 내역** | 수기 기록 | ✅ 앱에서 수기 입력 + 연결 시 선생님 확인 상태 표시 |
...
4. **기존 정기레슨 → 앱 전환**: QR 스캔 후 선생님이 수강권 직접 등록
   ...
   - 👉 상세: [flow_with_app.md 섹션 2.5](../../_archive/old/flow_with_app.md#25-기존-정기레슨--앱-전환-플로우) (아카이브됨)
