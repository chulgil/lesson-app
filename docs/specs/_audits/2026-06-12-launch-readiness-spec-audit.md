...
- [x] P1 → GitHub 구현 이슈 생성 완료 (2026-06-12): #692 일정변경 만료, #693 입금 대기 가시성, #694 알림 설정 Phase 1.5, #695 전화인증 draft 복구, #696 중복 제안 차단
- [x] 변경권 마감 모순 해소 — 동적 고지 결정 (reschedule_credit_spec.md §3, 요청 화면 고정 24h 문구 제거)
- [ ] §8 / §3.2.4 구현 (#692, #693)
- [ ] P2 13건 → 추적 이슈 #697 (다음 분기 스펙 정리 사이클)
