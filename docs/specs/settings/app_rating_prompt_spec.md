# 앱스토어 평점 유도 — 마일스톤 축하 카드 (v2)

> 버전: 2.0 (v1 팝업 다이얼로그 → v2 인라인 마일스톤 카드)
> 작성일: 2026-05-08
> 상태: 구현 완료

## ⚠️ v1 → v2 전면 수정 (2026-05-08)

**v1 문제**: 팝업 다이얼로그로 "리뷰하기" 요청 → 선생님 작업 흐름 방해 → 귀찮음 유발
**v2 해결**: 인라인 마일스톤 축하 카드 + 프로필 소프트 링크

| 항목 | v1 (폐기) | v2 (현재) |
|------|----------|----------|
| 형태 | 팝업 다이얼로그 (작업 차단) | 인라인 카드 (대시보드에 자연스럽게) |
| 트리거 | 레슨 5회 + 7일 | **마일스톤 달성** (50/100/200/500/1000회) |
| 톤 | "도움이 되나요?" (부담) | "🎉 100회 레슨 달성!" (축하) |
| 리뷰 유도 | 강제 2단계 (만족→리뷰) | **소프트 링크** (터치하고 싶을 때만) |
| 닫기 | dismiss 3회 후 영구 | × 버튼 즉시 닫기 |
| 위치 | 어디서든 팝업 | 홈 대시보드 인라인 + 프로필 하단 |
