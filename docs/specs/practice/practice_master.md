...
| 1.5 (미완) | 트림 후 실제 재생 시간 표시 (Issue #7), 연습완료 날짜별 동기화 (Issue #8) | 미완료 |
...
| Phase | 내용 | 상태 |
|-------|------|:----:|
| 1 | 학생 -> 선생님 공유 인프라, 선생님 연습 현황 탭 | 인프라 완료, 탭 미구현 |
| 2 | 학부모 대시보드 실데이터 연동 | 미구현 |
| 3 | 학부모 녹음 재생, 선생님 코멘트 | 미구현 |
...
|------|------|:----:|------|
| **연습 코어** | | | |
| | 연습 화면 (날짜 선택, 레퍼토리/섹션 목록) | 구현 완료 | 과거 날짜 필터 미완 |
...
| | 트림 후 실제 재생 시간 표시 | 미완료 | Issue #7 |
| | 연습완료 날짜별 동기화 | 미완료 | Issue #8 |
...
| Issue | 내용 | 상태 |
|-------|------|------|
| #7 | 스마트 녹음 트림 후 실제 재생 시간 표시 | 미완료 |
| #8 | 연습완료 날짜별 완료 상태 동기화 | 미완료 |
