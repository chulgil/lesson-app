...
|---|------|----------|------|:---------:|:----:|
| 1-1 | 학생 탭 클래스별 그룹화 | #42 | student_class_system.md | S | review |
| 1-2 | 프로필 탭 미수금 관리 | #43 | subscription_master.md | M | todo |
| 1-3 | 기존 정기레슨 앱 전환 플로우 | #59 | flow_with_app.md | M | todo |
| 1-4 | 약관 동의 화면 | - | terms_agreement | S | in-progress |
...
| 3-5 | 팔로우/소식 피드 | follow_master.md Phase 3 | M | LOW |
