...
> ⚠️ **레거시 문서**: 이 스펙은 **시간 오픈 → 학생 선택** 방식으로 대체되었습니다.
> 최신 스펙: [teacher_availability_spec.md](../schedule/teacher_availability_spec.md)
>
> **변경 내용** (2026-01-27):
> - ❌ 학생이 1순위/2순위/3순위 지정 → ✅ 선생님이 시간 오픈, 학생이 원클릭 선택
> - ❌ 다중 옵션 협상 → ✅ 가용 시간 중 즉시 선택
> - 조율 횟수: 1회 → **0회** (조율 자체 불필요)
