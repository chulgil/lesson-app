...
수강권 도메인의 현행 "결제"는 앱 내 결제가 아니다. 선생님/학원과 학생/학부모 사이의 수강료는 앱 밖에서 무통장입금, 현금 등으로 처리하고, 앱은 수강권 제안/입금 알림/수강권 발급 상태만 기록한다.

| 흐름 | 정책 | 앱의 역할 |
|------|------|-----------|
| 선생님 ↔ 학생/학부모 | 무통장입금/현금 등 외부 결제 | 수강권 제안, 입금 완료 표시, 수강권 확정 상태 기록 |
| 학원 ↔ 학생/학부모 | 무통장입금/현금 등 외부 결제 | 학원 수강권 상태 기록 |
