...
| 이슈 | 내용 | 우선순위 |
|------|------|:--------:|
| [#7](https://github.com/chulgil/lesson-app/issues/7) | 스마트 녹음 트림 후 실제 재생 시간 표시 | 🟠 High |
...
| 기능 | 설명 | 우선순위 |
|------|------|:--------:|
| 뱃지 시스템 | 연습 성과 보상 (스트릭, 목표 달성) | 🟠 High |
