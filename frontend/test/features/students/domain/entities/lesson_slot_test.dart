...
void main() {
  ...
  group('LessonSlot', () {
    ...
    test('dayLabel — 0=월 ~ 6=일', () {
      expect(const LessonSlot(dayOfWeek: 0, startTime: '10:00', endTime: '11:00').dayLabel, '월');
      expect(const LessonSlot(dayOfWeek: 1, startTime: '10:00', endTime: '11:00').dayLabel, '화');
      expect(const LessonSlot(dayOfWeek: 2, startTime: '10:00', endTime: '11:00').dayLabel, '수');
      expect(const LessonSlot(dayOfWeek: 3, startTime: '10:00', endTime: '11:00').dayLabel, '목');
      expect(const LessonSlot(dayOfWeek: 4, startTime: '10:00', endTime: '11:00').dayLabel, '금');
      expect(const LessonSlot(dayOfWeek: 5, startTime: '10:00', endTime: '11:00').dayLabel, '토');
      expect(const LessonSlot(dayOfWeek: 6, startTime: '10:00', endTime: '11:00').dayLabel, '일');
    });

    test('displayLabel — "화요일 14:00~15:00"', () {
      const slot = LessonSlot(dayOfWeek: 1, startTime: '14:00', endTime: '15:00');
    ...
    test('copyWith', () {
      const slot = LessonSlot(dayOfWeek: 0, startTime: '10:00', endTime: '11:00');
      final updated = slot.copyWith(dayOfWeek: 3, startTime: '16:00', endTime: '17:00');
