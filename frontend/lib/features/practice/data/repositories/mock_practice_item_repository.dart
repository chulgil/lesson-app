...
class MockPracticeItemRepository implements PracticeItemRepository {
  ...
  Future<List<PracticeItem>> getAwaitingFeedback(String teacherId) async {
    ...
    return _items
        .where(
          (item) =>
              item.teacherId == teacherId && item.isCompleted && !item.hasLike,
        )
        .toList()
      ..sort(
