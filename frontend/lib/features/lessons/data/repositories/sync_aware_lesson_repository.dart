...
/// Decorator that wraps [RemoteLessonRepository] with offline queue support.
///
/// - All read methods delegate directly to the remote repository.
/// - Mutation methods (create, update, delete, cancel, archive, unarchive)
///   use [MutationQueueHelper] to handle offline scenarios with optimistic results.
class SyncAwareLessonRepository implements LessonRepository {
  ...
  // ============================================================================
  // Read methods — delegate directly to remote
  // ============================================================================
