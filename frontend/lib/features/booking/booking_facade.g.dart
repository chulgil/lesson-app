...
class StudentBookingListFamily extends Family<AsyncValue<List<LessonBooking>>> {
  ...
  ///
  /// Copied from [studentBookingList].
  StudentBookingListProvider call(
    String studentId,
  ) {
    return StudentBookingListProvider(
      studentId,
    );
  }
...
class StudentBookingListProvider
  ...
  ///
  /// Copied from [studentBookingList].
  StudentBookingListProvider(
    String studentId,
  ) : this._internal(
          (ref) => studentBookingList(
            ref as StudentBookingListRef,
            studentId,
          ),
...
class TeacherBookingListFamily extends Family<AsyncValue<List<LessonBooking>>> {
  ...
  ///
  /// Copied from [teacherBookingList].
  TeacherBookingListProvider call(
    String teacherId,
  ) {
    return TeacherBookingListProvider(
      teacherId,
    );
  }
...
class TeacherBookingListProvider
  ...
  ///
  /// Copied from [teacherBookingList].
  TeacherBookingListProvider(
    String teacherId,
  ) : this._internal(
          (ref) => teacherBookingList(
            ref as TeacherBookingListRef,
            teacherId,
          ),
...
class PendingBookingListFamily extends Family<AsyncValue<List<LessonBooking>>> {
  ...
  ///
  /// Copied from [pendingBookingList].
  PendingBookingListProvider call(
    String teacherId,
  ) {
    return PendingBookingListProvider(
      teacherId,
    );
  }
...
class PendingBookingListProvider
  ...
  ///
  /// Copied from [pendingBookingList].
  PendingBookingListProvider(
    String teacherId,
  ) : this._internal(
          (ref) => pendingBookingList(
            ref as PendingBookingListRef,
            teacherId,
          ),
...
class UpcomingConfirmedFamily extends Family<AsyncValue<List<LessonBooking>>> {
  ...
  ///
  /// Copied from [upcomingConfirmed].
  UpcomingConfirmedProvider call(
    String teacherId,
  ) {
    return UpcomingConfirmedProvider(
      teacherId,
    );
  }
...
class UpcomingConfirmedProvider
  ...
  ///
  /// Copied from [upcomingConfirmed].
  UpcomingConfirmedProvider(
    String teacherId,
  ) : this._internal(
          (ref) => upcomingConfirmed(
            ref as UpcomingConfirmedRef,
            teacherId,
          ),
...
class TeacherSlotsFamily extends Family<AsyncValue<List<TimeSlot>>> {
  ...
  ///
  /// Copied from [teacherSlots].
  TeacherSlotsProvider call(
    String teacherId,
  ) {
    return TeacherSlotsProvider(
      teacherId,
    );
  }
...
class TeacherSlotsProvider extends AutoDisposeFutureProvider<List<TimeSlot>> {
  ...
  ///
  /// Copied from [teacherSlots].
  TeacherSlotsProvider(
    String teacherId,
  ) : this._internal(
          (ref) => teacherSlots(
            ref as TeacherSlotsRef,
            teacherId,
          ),
