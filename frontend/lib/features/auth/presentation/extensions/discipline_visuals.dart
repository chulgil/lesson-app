...
/// presentation boundary (domain stays string-free). Music is the only
/// registered discipline (#1278). A later phase supersedes this with the
/// design's StringOverlay / a shared
