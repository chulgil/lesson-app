...
List<Teacher> _generateMockTeachers() {
  ...
  return [
    ...
    Teacher(
      ...
      instruments: ['첼로'],
      bio:
          '한국예술종합학교 음악원 졸업 후 오케스트라 단원으로 활동하며 '
    ...
    Teacher(
      ...
      instruments: ['바이올린'],
      bio:
          '연세대학교 음대 졸업, 전문 교육자로서 10년 이상의 경력을 가지고 있습니다. '
    ...
    Teacher(
      ...
      bio:
          '바이올린/비올라 실기와 함께 음악이론, 화성학, 시창청음 수업도 가능합니다. '
          '입시 준비생들에게 특히 추천드립니다.',
