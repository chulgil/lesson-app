...
Student _$StudentFromJson(Map<String, dynamic> json) => Student(
  ...
  level:
      $enumDecodeNullable(_$StudentLevelEnumMap, json['level']) ??
  ...
  lessonSlots:
      (json['lesson_slots'] as List<dynamic>?)
  ...
  practiceStatus:
      $enumDecodeNullable(_$PracticeStatusEnumMap, json['practice_status']) ??
  ...
  manualAgeGroup: $enumDecodeNullable(
    _$AgeGroupEnumMap,
    json['manual_age_group'],
  ),
  ...
  practiceLevel: $enumDecodeNullable(
    _$PracticeLevelEnumMap,
    json['practice_level'],
  ),
