...
class AppStrings {
  ...
  /// 노쇼 표시 시 보강 크레딧 지급 체크박스 라벨 (선택, 기본 OFF).
  static const lessonNoShowGrantMakeupCreditLabel = '보강 크레딧 지급 (선택)';

  /// 위 체크박스 보조 설명.
  static const lessonNoShowGrantMakeupCreditDescription =
      '학생에게 보강 1회 크레딧을 지급해요. (만료 30일)';
  ...
  static const notifGroupRefundProgress = '환불 진행';
  ...
  /// 제안 거절 (subscription proposal reject confirm dialog title)
  static const proposalRejectConfirmTitle = '제안 거절';

  /// 거절 확인 본문 (subscription proposal reject confirm dialog body)
