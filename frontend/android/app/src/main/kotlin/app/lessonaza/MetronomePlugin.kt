...
import app.lessonaza.audio.OboeMetronomeEngine
...
class MetronomePlugin : FlutterPlugin, MethodCallHandler, EventChannel.StreamHandler {
    ...
    override fun onAttachedToEngine(binding: FlutterPlugin.FlutterPluginBinding) {
        ...
        methodChannel = MethodChannel(binding.binaryMessenger, "app.lessonaza/metronome")
        methodChannel.setMethodCallHandler(this)

        eventChannel = EventChannel(binding.binaryMessenger, "app.lessonaza/metronome_events")
