...
| 순서 | 이슈 | 작업 | 복잡도 | 상태 |
|:----:|:----:|------|:------:|:----:|
| 1 | #87 | 과제 UI 단순화 (색상/뱃지 제거, 좋아요 토글) | M | done |
| 2 | #88-A | 피드백 저장 버그 수정 (onChanged 연결) | S | done |
| 3 | #88-B | 빠른 피드백 UI (학생 선택 → 피드백 작성) | M | done |
| 4 | #89 | 연습 유형 통합 (레퍼토리 기반 단순화) | L | done |
| — | #87+ | 과제 편집 UX 분석 + 완료 과제 경고 배너 | S | done |

### 스펙 문서
- `docs/specs/lesson/assignment_ui_simplification.md` — 과제 UI 단순화
- `docs/specs/lesson/quick_feedback_spec.md` — 빠른 피드백
- `docs/specs/lesson/practice_type_unification.md` — 연습 유형 통합

---

## 이전 계획: 스펙 vs 코드 종합 분석
...
| 1-4 | 약관 동의 화면 | done |
| 1-5 | Google SSO 연동 마무리 (프론트 완료, 백엔드 의존) | done |
...
| 2-8 | **학습 자료 공유 Phase 1 (유튜브 링크)** | HIGH |
| 2-9 | **AI 레슨 노트 Phase 1** | HIGH |
