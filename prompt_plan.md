...
- 5-2c 나머지 lessons 큰 파일 (lesson_notes_widgets, lesson_detail_screen, add_lesson, edit_lesson, add_practice_item_sheet, quick/bulk_feedback ~150 사이트)
...
| **다음** P2 5-2c lessons 큰 파일 (lesson_notes_widgets / lesson_detail / add_lesson / edit_lesson / add_practice_item / quick/bulk_feedback ~150 사이트) | 대기 |
