"""Service for public app version, news, and roadmap data."""
...
class AppVersionService:
    """Read app version information for update and trust-building surfaces."""

    def __init__(self, db: AsyncSession) -> None:
        self.db = db

    async def get_app_version(self, platform: str) -> AppVersionResponse:
