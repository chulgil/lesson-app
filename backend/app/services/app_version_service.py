...
from app.schemas.app_version import AppVersionResponse, NewsItemResponse, RoadmapItemResponse, VersionResponse


class AppVersionService:
    """Read public app version metadata."""
    ...
    async def get_app_version(self, platform: str | None) -> AppVersionResponse:
        ...
        news = [
            ...
            for row in news_result.scalars().all()
        ]
        ...
        roadmap = [
            ...
            for row in roadmap_result.scalars().all()
        ]
