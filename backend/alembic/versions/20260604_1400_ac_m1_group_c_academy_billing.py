...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("payment_methods", sa.JSON(), nullable=False, server_default=sa.text("'[]'::json")),
    ...
    op.create_table(
        ...
        sa.Column("adjustment_log", sa.JSON(), nullable=False, server_default=sa.text("'[]'::json")),
        sa.Column("note", sa.Text(), nullable=True),
