...
| C5 | **사용자 한글은 AppStrings/AppLocalizations만.** 인라인 리터럴 금지. **신규 문자열은 ARB+AppLocalizations** — AppStrings 신규 상수 금지(app_strings_ratchet_test) | `rg -n "Text\('[가-힣]" frontend/lib/features/` · 훅 `i18n-l10n-guard.py` |
